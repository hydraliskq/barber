...
***************************************************************************** */
    ...
    const openMenu = () => header.classList.toggle(classest.menu);
    const scrollToSection = e => {
        ...
        if (header.classList.contains(classest.menu)) header.classList.remove(classest.menu);
        window.scrollTo({
            top,
            behavior: "smooth"
        });
    ...
    const handleScroll = () => {
        ...
        sections.forEach((section => {
            if (y > section.offsetTop - h / 1.5) section.classList.remove(classest.hidden);
        }));
    };
